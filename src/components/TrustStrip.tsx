...
const TrustStrip = () => {
  return (
    <section className="bg-[#F7F7F5] pt-14 py-12 border-t border-black/5">
      <div className="container-narrow py-5 md:py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[14px] md:text-[15px] text-muted-foreground tracking-[-0.01em]">
            <span className="text-sm font-medium text-primary">NIVI i media:</span>{" "}
          ...
          <Link 
            to="/i-media" 
            className="group inline-flex items-center gap-2 text-[14px] font-medium text-primary hover:text-accent hover:underline underline-offset-4 transition-colors duration-200"
          >
            Se alle omtaler
